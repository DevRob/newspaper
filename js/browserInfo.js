...
var browserInfo = {
    ...
    capabilities: {
        ...
        _ActiveX: {
            label: "ActiveX:",
            value: function() {
                return window.ActiveXObject ? 'Your browser SUPPORTS ActiveX' : 'Your browser DOES NOT SUPPORT ActiveX controls'
            }
        }
    },
    computer: {
        ...
        colorDepth: {
            label: "Color depth:",
            value: function() {
                return `${screen.colorDepth} bits per pixel`
            }
        },
        browserDimensions: {
        ...
        memory: {
            label: "Memory:",
            value: function() {
                return `${navigator.deviceMemory}GB (estimated)`
            }
        },
        core: {
            label: "CPU core:",
            value: function() {
                return `${navigator.hardwareConcurrency} (estimated)`
            }
        },
        jsVersion: {
    ...
    _HTML5: {
        ...
        value: {
            canvas: (function() {
                return Modernizr.canvas ? 'Yes' : 'No'
            })(),
            canvas_text: (function() {
                return Modernizr.canvastext ? 'Yes' : 'No'
            })(),
            drag_and_drop: (function() {
                return 'draggable' in document.createElement('span') ? 'Yes' : 'No'
            })(),
            audio: (function() {
            ...
            web_workers: (function() {
                return Modernizr.webworkers ? 'Yes' : 'No'
            })(),
            web_sockets: (function() {
                return Modernizr.websockets ? 'Yes' : 'No'
            })(),
            session_storage: (function() {
                return Modernizr.sessionstorage ? 'Yes' : 'No'
            })(),
            web_SQL_database: (function() {
                return Modernizr.websqldatabase ? 'Yes' : 'No'
            })()
        }
    },
    _CSS3: {
